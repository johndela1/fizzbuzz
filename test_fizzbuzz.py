...
from fizzbuzz import fizz_buzz, fizz_buzz_tr1, fizz_buzz_tr2
...
@pytest.mark.parametrize("arg, expected", args_to_expected)
def test_fizz_buzz_tr1(arg, expected):
    assert fizz_buzz_tr1(arg) == expected


@pytest.mark.parametrize("arg,expected", args_to_expected)
def test_fizz_buzz_tr2(arg, expected):
    assert fizz_buzz_tr2(arg) == expected


@pytest.mark.parametrize("f", [fizz_buzz_tr1, fizz_buzz_tr2])
def test_fizz_buzz(f):
