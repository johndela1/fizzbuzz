...
from fizzbuzz import fizz_buzz, fizz_buzz1, fizz_buzz2
...
def test_fizz_buzz1(arg, expected):
    assert fizz_buzz1(arg) == expected

@pytest.mark.parametrize("arg,expected", args_to_expected)
def test_fizz_buzz2(arg, expected):
    assert fizz_buzz2(arg) == expected

@pytest.mark.parametrize("f", [fizz_buzz1, fizz_buzz2])
